...
export class WorkspacePageStore implements IWorkspacePageStore {
  ...
  /**
   * @description get all the workspace page ids
   */
  ...
  /**
   * @description moving pages between projects is not supported for workspace/wiki pages
   */
  movePage = async () => {
    throw new Error("Moving wiki pages is not supported.");
  };
}
