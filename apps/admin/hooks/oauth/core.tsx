...
import { KeyRound, LockKeyhole, Mails } from "lucide-react";
// types
import type {
...
export const getCoreAuthenticationModesMap: (
  ...
  oidc: {
    key: "oidc",
    name: "OIDC",
    description: "Sign in with your OpenID Connect provider (e.g. Keycloak).",
    icon: <LockKeyhole className="h-6 w-6 p-0.5 text-tertiary" />,
