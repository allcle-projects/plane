# Page Comments (mote) — document-level comment rail (v1).
# See docs/mote-design/02-wiki-publishing.md, Feature 1.
#
# Adds two net-new tables (PageComment, PageCommentReaction) plus the
# partial-unique-on-soft-delete constraint on reactions. No changes to any
# existing table.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("db", "0126_integration_option_b_mappings"),
    ]
