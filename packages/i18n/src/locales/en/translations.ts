...
export default {
  ...
  project_settings: {
    ...
    automations: {
      ...
      custom: {
        ...
        description: "Define your own trigger, condition, and action rules for this project.",
        new_rule: "New rule",
        edit_rule: "Edit rule",
        create_rule: "New rule",
        empty_state: "No custom automations yet. Create a rule to automate state, priority, and label changes.",
        name: "Name",
        name_placeholder: "e.g. Auto-close stale bugs",
        ...
        value_placeholder: "Value (id, or comma-separated ids)",
        ...
        actions: {
          ...
          set_completed_at: "Set completed date",
          pick_label: "Pick a label",
        },
        toasts: {
          created: "Automation rule created.",
          updated: "Automation rule updated.",
          deleted: "Automation rule deleted.",
          save_failed: "The rule could not be saved. Please try again.",
          delete_failed: "Could not delete the rule.",
          toggle_failed: "Could not update the rule.",
          name_required: "Name is required.",
          condition_incomplete: "Each condition needs a field and an operator.",
          action_incomplete: "Each action needs a type.",
        },
      },
    },
    recurring: {
  ...
  publish_view: {
    menu_label: "Publish view",
    menu_update_label: "Publish settings",
    modal_title: "Publish view",
    live_message: "This view is now live on web",
    layouts_label: "Views",
    comments_label: "Allow comments",
    reactions_label: "Allow reactions",
    votes_label: "Allow voting",
    anyone_with_link: "Anyone with the link can access",
    copy_link: "Copy link",
    unpublish: "Unpublish",
    ...
    updating: "Updating",
    toast: {
      layout_required: "Please select at least one view layout to publish the view.",
      update_success: "Publish settings updated successfully!",
      publish_error: "Something went wrong while publishing the view.",
      unpublish_error: "Something went wrong while unpublishing the view.",
      link_copied: "Published view link copied successfully.",
    },
  },
} as const;
