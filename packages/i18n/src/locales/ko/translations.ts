...
export default {
  ...
  project_settings: {
    ...
    automations: {
      ...
      custom: {
        heading: "커스텀 자동화",
        description: "이 프로젝트를 위한 트리거·조건·액션 규칙을 직접 정의하세요.",
        new_rule: "새 규칙",
        edit_rule: "규칙 편집",
        create_rule: "새 규칙",
        empty_state: "아직 커스텀 자동화가 없습니다. 규칙을 만들어 상태·우선순위·라벨 변경을 자동화하세요.",
        name: "이름",
        name_placeholder: "예: 오래된 버그 자동 닫기",
        ...
        actions_label: "액션",
        add_action: "액션 추가",
        value_placeholder: "값 (id 또는 콤마로 구분된 id 목록)",
        no_params: "파라미터 없음",
        cancel: "취소",
        save: "저장",
        create: "생성",
        conditions_count: "조건 {count}개",
        actions_count: "액션 {count}개",
        triggers: {
          issue_created: "작업 항목 생성됨",
          state_changed: "상태 변경됨",
        ...
        actions: {
          ...
          add_label: "라벨 추가",
          remove_label: "라벨 제거",
          set_completed_at: "완료일 설정",
          pick_label: "라벨 선택",
        },
        toasts: {
          created: "자동화 규칙이 생성되었습니다.",
          updated: "자동화 규칙이 수정되었습니다.",
          deleted: "자동화 규칙이 삭제되었습니다.",
          save_failed: "규칙을 저장하지 못했습니다. 다시 시도해 주세요.",
          delete_failed: "규칙을 삭제하지 못했습니다.",
          toggle_failed: "규칙을 업데이트하지 못했습니다.",
          name_required: "이름을 입력해 주세요.",
          condition_incomplete: "각 조건에는 필드와 연산자가 필요합니다.",
          action_incomplete: "각 액션에는 유형이 필요합니다.",
        },
      },
    },
    empty_state: {
  ...
  // Publish Views — mote (docs/mote-design/02-wiki-publishing.md, Feature 5)
  publish_view: {
    menu_label: "뷰 게시",
    menu_update_label: "게시 설정",
    modal_title: "뷰 게시",
    live_message: "이 뷰는 현재 웹에 게시되어 있습니다",
    layouts_label: "뷰",
    comments_label: "댓글 허용",
    reactions_label: "반응 허용",
    votes_label: "투표 허용",
    anyone_with_link: "링크가 있는 모든 사람이 접근할 수 있습니다",
    copy_link: "링크 복사",
    unpublish: "게시 취소",
    ...
    updating: "업데이트 중",
    toast: {
      layout_required: "뷰를 게시하려면 최소 하나의 레이아웃을 선택해 주세요.",
      update_success: "게시 설정이 업데이트되었습니다!",
      publish_error: "뷰를 게시하는 중 문제가 발생했습니다.",
      unpublish_error: "뷰 게시를 취소하는 중 문제가 발생했습니다.",
      link_copied: "게시된 뷰 링크가 복사되었습니다.",
    },
  },
} as const;
